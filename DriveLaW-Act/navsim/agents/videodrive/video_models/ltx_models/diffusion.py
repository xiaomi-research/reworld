...
from navsim.agents.videodrive.video_models.diffusion_planner.diffusion_planner import preprocessing_action_states, add_action_expert
...
class LTXVideoTransformer3DModel(
    ...
    def forward(
        ...
        if return_action:
            ...
            action_temb_fused, action_embedded_timestep, action_rotary_emb, action_hidden_states,hist_ctx, hist_mask = preprocessing_action_states(self, action_states, action_timestep,context_dict)
            ...
            if torch.is_grad_enabled() and self.gradient_checkpointing:
                ...
                if return_action:
                    ...
                    action_hidden_states = self.action_blocks[block_idx](
                        ...
                        attn3_hidden_states=hist_ctx,              
                        attn3_attention_mask=hist_mask,    
                    )
            else:
                if return_video or store_buffer:
                    hidden_states = block(
                ...
                if return_action:
                    ...
                    ### action_hidden_states: random actions, b v c
                    ### 
                    final_hidden_states = hidden_states # rearrange(hidden_states, '(b v) l c -> b (v l) c', v=n_view)
