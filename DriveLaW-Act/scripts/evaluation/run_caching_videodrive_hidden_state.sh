# Caches NavSim features (e.g. images + trajectories) via run_dataset_caching.py — not DiT/VAE tensors.
# IG / DiT changes do not require changes to this script (caches NavSim features only).
