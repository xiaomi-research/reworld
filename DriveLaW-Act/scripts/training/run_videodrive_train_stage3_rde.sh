...
torchrun --nproc_per_node=$RESOURCE_GPU \
    ...
    agent.config_file="${NAVSIM_DEVKIT_ROOT}/navsim/agents/videodrive/configs/ltx_model/video_model_train_stage3_rde.yaml" \
    experiment_name=training_video_agent_stage3_rde \
